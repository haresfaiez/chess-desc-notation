...
let shift file origin steps : Board.position = (file, Board.Rank (origin + steps))
let shiftRank piece (file, Board.Rank origin) steps = (piece, (file, Board.Rank origin), (shift file origin steps))
